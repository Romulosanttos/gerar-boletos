...
module.exports = {
  ...
  eRegistroNacional: {
    ...
    'Verifica que é possível especificar tipo de registro nacional a ser validado': function (
      test
    ) {
  ...
  eFilial: {
    'Verifica que é possível identificar uma filial pelo CNPJ, e que o seu número é retornado':
      function (test) {
