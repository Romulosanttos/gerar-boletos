...
var Beneficiario = (function () {
	...
	Beneficiario.prototype.getCodigoBarra = function () {
		return this._codigoDeBarras;
	};

	Beneficiario.prototype.comCodigoBarra = function (_codigoDeBarras) {
		this._codigoDeBarras = _codigoDeBarras;
		return this;
	};

	Beneficiario.prototype.getLinhaDigitavel = function () {
		return this._linhaDigitavel;
	};

	Beneficiario.prototype.comLinhaDigitavel = function (_linhaDigitavel) {
...
var Boleto = (function () {
	...
	Boleto.prototype.getLinhaDigitavelFormatado = function () {
		console.log(this._banco._codigoDeBarras);
