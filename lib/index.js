const BoletoUtils = require('./utils/functions/boletoUtils');
...
/**
 * @typedef {import('./utils/functions/boletoUtils').Boleto} Boleto
 * @typedef {import('./utils/functions/boletoUtils').Beneficiario} Beneficiario
 * @typedef {import('./utils/functions/boletoUtils').Pagador} Pagador
 * @typedef {import('./utils/functions/boletoUtils').Datas} Datas
 * @typedef {import('./utils/functions/boletoUtils').Endereco} Endereco
 */
